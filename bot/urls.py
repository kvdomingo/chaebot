...
urlpatterns = [
    ...
    path('group/<int:pk>/twitterMediaSubscribedChannels', views.GroupTwitterSubscribedChannelsApi.as_view()),
    path('group/<int:pk>/vliveSubscribedChannels', views.GroupVliveSubscribedChannelsApi.as_view()),
